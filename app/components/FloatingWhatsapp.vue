...
import { whatsappNumber } from '~/utils/siteData'
...
<template>
  <a
    ...
    aria-label="Fale com a Atlética Nexus no WhatsApp"
    class="fixed bottom-7 right-7 z-50 w-14 h-14 rounded-full bg-nx-green grid place-items-center shadow-[0_10px_28px_rgba(110,200,50,0.4)] transition-transform duration-150 hover:scale-105"
  >
    <svg width="22" height="22" viewBox="0 0 24 24" fill="#0d1a04">
